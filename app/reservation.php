...
<head>
    ...
    <title>eHotel - Create Reservation</title>
...
<div class="container my-4" style="max-width: 700px;">
    ...
    <!-- Room Details Card -->
    <div class="card shadow-sm mb-4" id="roomCard">
        <div class="card-header bg-primary text-white fw-semibold">Room Details</div>
        ...
        <div class="card shadow-sm mb-4">
            ...
            <div class="card-body row g-3">
                <div class="col-md-6">
                    ...
                    <input type="date" class="form-control" name="start_date_display" id="start_date_display" required>
                </div>
                <div class="col-md-6">
                    <label class="form-label">Check-out</label>
                    <input type="date" class="form-control" name="end_date_display" id="end_date_display" required>
                </div>
            </div>
        </div>
...
$(function () {
    ...
    if (roomId) {
        $.get('api/get_rooms.php', function (res) {
            if (res.success) {
                ...
                if (room) {
                    const stars = '★'.repeat(room.category || 0) + '☆'.repeat(5 - (room.category || 0));
                    $('#roomDetails').html(`
                        <div class="row">
    ...
    // Sync date inputs to hidden fields
    ...
    $('#reservationForm').on('submit', function (e) {
        ...
        $.post('api/create_reservation.php', data, function (res) {
            if (res.success) {
                $('#alertBox').html(`<div class="alert alert-success">✅ Reservation #${res.reservation_id} created successfully! <a href="index.php" class="alert-link">Back to Search</a></div>`);
